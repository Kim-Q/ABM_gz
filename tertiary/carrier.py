...
class Carrier(Agent):
    ...
    def receive(self, target_loc, target_activity):
        # print("I'm a carrier with standpoint",str(self.standpoint),"receive the deployment of", target_activity)
    ...
    def dijin(self):
        if self.wait>0:
            ...
            self.receive(self.target_loc.pop(-1),self.target_activity.pop(-1))
